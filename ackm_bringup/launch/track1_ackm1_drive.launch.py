...
def generate_launch_description():
    ...
    pkg_project_mldrive = get_package_share_directory('ackm_mldrive')
    ...
    sdf_file  =  os.path.join(pkg_project_description, 'models', 'ackm1', 'model.sdf')
    ...
    # Bridge ROS topics and Gazebo messages for establishing communication
        ...
        parameters=[{
            'config_file': os.path.join(pkg_project_bringup, 'config', 'ros_gz_bridge_ackm1.yaml'),
    ...
    mldrive = ExecuteProcess(
		cmd=['/ws/venv/bin/python3',
			 '/ws/ros_ws/src/sibotr2/ackm_mldrive/scripts/model_drive.py',
			 '--ros-args',
